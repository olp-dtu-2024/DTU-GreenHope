...
export default class KafkaTrigger extends Trigger {
  static TriggerName = 'kafka';
  static Title = 'Kafka trigger'; // For display in UI
  static Description = 'Trigger workflow on Kafka events'; // For display in UI
  static schema = {
    type: 'object',
    properties: {
      topic: {
